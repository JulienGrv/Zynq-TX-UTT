...
CONFIG.mode_64bit {1} \
  ...
  # Create instance: doHistStretch_0, and set properties
  set doHistStretch_0 [ create_bd_cell -type ip -vlnv utt.fr:hls:doHistStretch:1.0 doHistStretch_0 ]

  # Create instance: doHist_0, and set properties
  set doHist_0 [ create_bd_cell -type ip -vlnv utt.fr:hls:doHist:1.0 doHist_0 ]

  # Create instance: doHist_0_bram, and set properties
  set doHist_0_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 doHist_0_bram ]
  set_property -dict [ list \
...
CONFIG.NUM_MI {5} \
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins doHist_0_bram/BRAM_PORTB]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster_0/M00_AXIS] [get_bd_intf_pins doHist_0/inStream]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins doHistStretch_0/inStream]
  connect_bd_intf_net -intf_net doHistStretch_0_outStream [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins doHistStretch_0/outStream]
  connect_bd_intf_net -intf_net doHist_0_histo_PORTA [get_bd_intf_pins doHist_0/histo_PORTA] [get_bd_intf_pins doHist_0_bram/BRAM_PORTA]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins doHistStretch_0/s_axi_CTRL_BUS] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins doHist_0/s_axi_CTRL_BUS] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins doHistStretch_0/ap_clk] [get_bd_pins doHist_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins doHistStretch_0/ap_rst_n] [get_bd_pins doHist_0/ap_rst_n] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs doHistStretch_0/s_axi_CTRL_BUS/Reg] SEG_doHistStretch_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs doHist_0/s_axi_CTRL_BUS/Reg] SEG_doHist_0_Reg
...
preplace inst doHistStretch_0 -pg 1 -lvl 3 -y 360 -defaultsOSRD
preplace inst axis_broadcaster_0 -pg 1 -lvl 2 -y 340 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 4 -y 460 -defaultsOSRD
preplace inst axi_timer_0 -pg 1 -lvl 3 -y 750 -defaultsOSRD
preplace inst rst_processing_system7_0_50M -pg 1 -lvl 1 -y 880 -defaultsOSRD
preplace inst doHist_0 -pg 1 -lvl 3 -y 80 -defaultsOSRD
preplace inst doHist_0_bram -pg 1 -lvl 4 -y 210 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 3 -y 220 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -y 430 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 2 -y 660 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 6 -y 720 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 6 1 NJ
preplace netloc axis_broadcaster_0_M00_AXIS 1 2 1 710
preplace netloc processing_system7_0_axi_periph_M03_AXI 1 2 1 770
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 2 2 NJ 470 1120
preplace netloc rst_processing_system7_0_50M_interconnect_aresetn 1 1 4 390 460 NJ 460 NJ 320 NJ
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 3 1 N
preplace netloc processing_system7_0_M_AXI_GP0 1 1 6 410 870 NJ 870 NJ 870 NJ 870 NJ 870 2300
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 7 30 790 NJ 860 NJ 860 NJ 860 NJ 860 NJ 860 2280
preplace netloc axis_broadcaster_0_M01_AXIS 1 2 1 N
preplace netloc axi_mem_intercon_M00_AXI 1 5 1 1840
preplace netloc rst_processing_system7_0_50M_peripheral_aresetn 1 1 4 380 270 760 510 1130 570 1530
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 2 1 720
preplace netloc doHist_0_histo_PORTA 1 3 1 1110
preplace netloc axi_dma_0_M_AXI_MM2S 1 4 1 1520
preplace netloc processing_system7_0_FIXED_IO 1 6 1 NJ
preplace netloc axi_dma_0_M_AXI_S2MM 1 4 1 1500
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 20 770 400 260 750 450 1150 340 1510 580 1830 850 2290
preplace netloc axi_dma_0_M_AXIS_MM2S 1 1 4 410 440 NJ 440 NJ 350 1490
preplace netloc processing_system7_0_axi_periph_M04_AXI 1 2 1 N
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 2 1 730
preplace netloc doHistStretch_0_outStream 1 3 1 1130
levelinfo -pg 1 0 200 560 940 1320 1680 2060 2320 -top 0 -bot 970
",
}
