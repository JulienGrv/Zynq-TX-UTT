...
if {[file isfile doHistStretch.autotvin.dat]} {
	file delete -force doHistStretch.autotvin.dat
}

if {[file isfile doHistStretch.autotvout.dat]} {
	file delete -force doHistStretch.autotvout.dat
}
