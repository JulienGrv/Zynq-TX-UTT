...
HD_PWD='/home/darkin/Workspace/Vivado_HLS/image_contrast_adj/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log doHistStretch.vdi -applog -m64 -messageDb vivado.pb -mode batch -source doHistStretch.tcl -notrace
