...
set id 1
set name doHistStretch_fmul_32ns_32ns_32_4_max_dsp
...
set id 2
set name doHistStretch_fdiv_32ns_32ns_32_16
...
set id 3
set name doHistStretch_sitofp_32s_32_6
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 4 \
			corename doHistStretch_CTRL_BUS_axilite \
			name doHistStretch_CTRL_BUS_s_axi \
			ports {$port_CTRL_BUS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler doHistStretch_CTRL_BUS_s_axi
}
