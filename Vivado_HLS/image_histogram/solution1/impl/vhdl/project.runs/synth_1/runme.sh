...
HD_PWD='/home/darkin/Workspace/Vivado_HLS/image_histogram/solution1/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log doHist.vds -m64 -mode batch -messageDb vivado.pb -notrace -source doHist.tcl
