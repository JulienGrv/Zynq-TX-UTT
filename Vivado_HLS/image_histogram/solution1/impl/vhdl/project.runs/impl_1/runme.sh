...
HD_PWD='/home/darkin/Workspace/Vivado_HLS/image_histogram/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log doHist.vdi -applog -m64 -messageDb vivado.pb -mode batch -source doHist.tcl -notrace
