...
HD_PWD='/home/darkin/Workspace/Vivado_HLS/convolution_2D/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log doImgProc.vdi -applog -m64 -messageDb vivado.pb -mode batch -source doImgProc.tcl -notrace
