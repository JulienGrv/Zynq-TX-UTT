...
HD_PWD='/home/darkin/Workspace/Vivado_HLS/convolution_2D/solution1/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log doImgProc.vds -m64 -mode batch -messageDb vivado.pb -notrace -source doImgProc.tcl
