...
## IP Info
set Vendor      "utt.fr"
set Library     "hls_video"
set IPName      "doImgProc"
set Version     "1.0"
set DisplayName "Doimgproc"
set Revision    "1606211642"
set Description "convolution of an image"
set Device      "zynq"
...
set Interfaces {
    ...
    s_axi_KERNEL_BUS {
        ...
        port_width "AWADDR 5 WDATA 32 WSTRB 4 ARADDR 5 RDATA 32"
        registers {}
        memories "kernel {base_address 16 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CRTL_BUS s_axi_KERNEL_BUS inStream outStream"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 2359816 II x}
...
set enable_xo_gen 0
set kernel_files {/home/darkin/Workspace/Vivado_HLS/convolution_2D/src/core.cpp}
if {$enable_xo_gen} {
